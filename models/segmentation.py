"""
虹膜分割模型定义
基于MobileNetV3 encoder + UNet decoder的轻量级分割网络
"""
import torch
...
class IrisSegmentationModel(nn.Module):
    """
    虹膜分割模型
    MobileNetV3 encoder + UNet decoder + ASPP + CBAM
    """
...
def build_segmentation_model(num_classes=1, pretrained=True, base_channels=32, use_boundary=False, backbone='mobilenet_v3'):
    """构建分割模型"""
    return IrisSegmentationModel(
